...
const inputDir = path.join(__dirname, 'gtcore', 'src');
const outputDir = path.join(__dirname, 'gtcore', 'dist');
const jsDir = 'js';
const cssDir = 'css';
...
module.exports = (env) => {
    ...
    return [{
        entry: { gtcore: path.join(inputDir, 'index.js') },
        output: {
        ...
        devServer: {
            contentBase: path.join(__dirname, "./gtcore/dist"),
            port: 8080,
            host: 'localhost',
